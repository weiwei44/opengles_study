 ...
 */
class FrameRect(val context:Context){
    ...
    fun initProgram(){
        val vertexCode = TextResourceReader.readTextFileFromResource(context, R.raw.egl_vertex_shader)
        val fragmentCode = TextResourceReader.readTextFileFromResource(context, R.raw.egl_fragment_shader)
    ...
    fun setAttrOrUniform(){
        ...
        uTexMatrixLoc = GLES20.glGetUniformLocation(programObjectId, "uTexMatrix")
    ...
    fun drawFrame(mTextureId:Int,texMatrix:FloatArray,mMvpMatrix:FloatArray){
